...
# fn6s, row6s, col6s, v6s, temp, labels = np.genfromtxt('Output\\RioTinto_Clean_result.csv', delimiter = ',', skip_header = 1, unpack = True)
fn7s, row7s, col7s, v7s, temp, labels = np.genfromtxt('Output\\RioTinto_Muddy_result.csv', delimiter = ',', skip_header = 1, unpack = True)
# fn6s = np.genfromtxt('Output\\RioTinto_Clean_result.csv', delimiter = ',', skip_header = 1, dtype = str, usecols = 0)
